                ...
                <fieldset class="form-group col-6">
                  ...
                  <fieldset class="form-group col-6">
                    ...
                    <fieldset class="form-group col-12">
                      ...
                      <input id="subject" type="text" name="subject" class="form-control @error ('subject') is-invalid @enderror" value="{{ old('subject') }}" placeholder="Subject ...">
                        @error('subject')
                          <div class="">{{ $message }}</div>
                        @enderror
                      </fieldset>
                      <fieldset class="form-group col-12">
                        ...
                        <textarea id="message" name="message" class="form-control @error ('message') is-invalid @enderror" rows="5" placeholder="Your message ...">{{ old('message') }}</textarea>
                          @error('message')
                            <div class="">{{ $message }}</div>
                          @enderror
                        </fieldset>
