    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-8">
          ...
          <p>Below is a list of the differents <a class="text-info" href="{{ route('about') }}"><b>APIs</b></a> services used on this website. Some of them are from well known websites, other are from open sources providers but nonetheless usefull.</p>
          <p>Only a small sample of the potential of thoses APIs is shown here, much more complexity and services can be achieved for all of them.</p>
