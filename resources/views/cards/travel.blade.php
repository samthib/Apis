<div class="col-md-6 col-xl-4">
  <div class="card m-1 m-md-4" style="background-image: url('{{ asset('storage/img/tourisme-mondial-cropped.png') }}')">

    <div class="card-header">
      <h5 class="card-title">Tripadvisor API</h5>
      <a href="https://www.tripadvisor.com/" target="_blank">
        <img class="card-icon" src="{{ asset('storage/img/Tripadvisor_logoset_solid_green.svg') }}" alt="">
      </a>
    </div>
    <div class="card-body">
    ...
    <div class="card-footer">
      <a href="https://www.tripadvisor.com/" class="text-white" target="_blank">Datas provider: <b>tripadvisor.com</b>
