<div class="col-md-6 col-xl-4">
  <div class="card m-1 m-md-4" style="background-image: url('{{ asset('storage/img/instagram.png') }}')">

    <div class="card-header">
      <h5 class="card-title">Instagram API</h5>
      <a href="https://www.instagram.com/" target="_blank">
        <img class="card-icon" src="{{ asset('storage/img/Instagram_logo.png') }}" alt="">
      </a>
    </div>
    <div class="card-body">
    ...
    <div class="card-footer">
      <a href="https://www.instagram.com/" class="text-white" target="_blank">Datas provider: <b>instagram.com</b>
