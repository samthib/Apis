<div class="col-md-6 col-xl-4">
  <div class="card m-1 m-md-4" style="background-image: url('{{ asset('storage/img/Facebook-Wallpaper-5.jpg') }}')">
    ...
    <div class="card-header">
      <h5 class="card-title">Facebook API</h5>
      <a href="https://www.facebook.com/" target="_blank">
        <img class="card-icon" src="{{ asset('storage/img/facebook-icon-cropped.png') }}" alt="">
      </a>
    </div>
    <div class="card-body">
    ...
    <div class="card-footer">
      <a href="https://www.facebook.com/" class="text-white" target="_blank">Datas provider: <b>facebook.com</b>
